...
namespace CustomerManager
{
    public interface ICustomersView
    {
        ...
        void ClearTxt();
        void AddCustomerToGrid(Customer customer);
        void UpdateGridWithChangedCustomer(Customer customer);
        void RemoveCustomerFromGrid(Customer customer);
        string GetIdOfSelectedCustomerInGrid();
        bool CheckTxt();
        void SetSelectedCustomerInGrid(Customer customer);

        string FirstName { get; set; }
        string LastName { get; set; }
        string ID { get; set; }
        string Nationality { get; set; }
        Customer.SexOfPerson Sex { get; set; }
    ...
    public class CustomersController
    {
        ...
        public CustomersController(ICustomersView view, IList customers)
        {
            _view = view;
